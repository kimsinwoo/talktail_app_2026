...
export type TabParamList = {
  Home: undefined;
  Monitoring:
    | { petId?: string; petName?: string; petImage?: string }
    | undefined;
...
function App(): React.JSX.Element {
  ...
  useEffect(() => {
    ...
    Promise.resolve().then(async () => {
      try {
        const binding = await apiService.post<{
        ...
        <NavigationContainer>
          <Stack.Navigator screenOptions={{ headerShown: false }}>
              ...
              {() => (
                ...
                >
                  ...
                  >
                    {props => {
                      const petProps = useMemo(
                        () => ({
                          petId:
                            pets.find(p => p.pet_code === selectedPetCode)
                              ?.pet_code ||
                            pets[0]?.pet_code ||
                            '',
                          petName:
                        ...
                        return (
                          <SafeAreaProvider>
                            ...
                            >
                              ...
                              <TouchableOpacity
                                onPress={() =>
                                  props.navigation.navigate('PetRegister')
                                }
                                style={{
                                  backgroundColor: '#f0663f',
                  ...
                  >
                    {props => (
                      <MyPageScreen
                        {...props} /* onAddToCart={handleAddToCart} */
                      />
                    )}
                  </Tab.Screen>
                </Tab.Navigator>
            ...
            <Stack.Screen
              ...
              component={HealthCheckStartScreen}
            />
            <Stack.Screen
              name="HealthCheckResult"
              component={HealthCheckResultScreen}
            />
            ...
            />
            <Stack.Screen
              name="HubDeviceManagement"
              component={HubDeviceManagementScreen}
            />
            ...
            <Stack.Screen
              ...
              component={DailyHealthCheckScreen}
            />
            <Stack.Screen
              name="RecentStatusTrend"
              component={RecentStatusTrendScreen}
            />
            <Stack.Screen
